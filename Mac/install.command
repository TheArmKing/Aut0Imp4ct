...
if [ ! -f "\$HOME/Library/Aut0Imp4ct/details.txt" ] || [ "\$(tail -n +1 \$HOME/Library/Aut0Imp4ct/details.txt | head -n1)" == "" ] || [ "\$(tail -n +1 \$HOME/Library/Aut0Imp4ct/details.txt | head -n1)" == "" ] ; then
  ...
  echo -en "\x1B[0;49;91mDetails were either corrupted or not found!\nEnter your details now!\x1B[0m\n"
  cbz=0
  while (( !cbz )); do
  ...
  echo -en "\x1B[0;49;32mDetails Stored!\x1B[0m File is \x1B[1;49;39m\$HOME/Library/Aut0Imp4ct/details.txt\x1B[0m"
elif [ "\$(pgrep -x -- "Impactor")" == "" ]; then
  echo -en "\x1B[0;49;91mImpactor Not Running!\x1B[0m\n"
  exit
fi
...
echo -en "\x1B[1;49;92mAuto-Impacted!\x1B[0m\n"
EOF
